...
```
```shell
//192.168.123.2/公共空间 /opt/Docker/Nginx/HTML/files.com/公共空间 cifs username=root,password=6811396yang,vers=1.0
UUID=****** /opt/Disk exfat defaults 0 0
```
临时挂载
```shell
sudo mount -t cifs -o username=root,password=6811396yang,file_mode=0777,dir_mode=0777 //192.168.123.2/公共空间 /opt/Docker/Nginx/HTML/files.com/公共空间
```
## 网络配置
